...
const DraggableSlider4: React.FC = () => {
  ...
  useEffect(() => {
    const handleMove = (clientX: number) => {
      ...
      if (sliderContainer) {
        ...
        dispatch({ type: "ADD_ITEM4", payload: value * 250000 });
      }
    };
  ...
  return (
    ...
    >
      <div className="price">{state.shelf4[0]}Ft</div>
      <div className="slider-name2">SZENT ISTVÁN KIRÁLY ZENEI ALAPITVÁNY</div>
      ...
      {infoVisible && (
        <div className="infoDiv">
          ...
          <h2>Szent István király zenei alapitvány</h2>
          <p>
...
export default DraggableSlider4;
