...
const DraggableSlider2: React.FC = () => {
  ...
  useEffect(() => {
    const handleMove = (clientX: number) => {
      ...
      if (sliderContainer) {
        ...
        dispatch({ type: "ADD_ITEM2", payload: value * 250000 });
      }
    };
  ...
  return (
    ...
    >
      <div className="price">{state.shelf2[0]}Ft</div>
      <div className="slider-name">LÁMPÁS `92 ALAPITVÁNY</div>
...
export default DraggableSlider2;
